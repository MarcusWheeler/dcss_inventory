...
iterations = 30
replace_frame = 5
vec_env = make_vec_env("dcss_examples/Inventory-v0", n_envs=10, env_kwargs={"render_mode": "None", "verbose_output": "False", "max_iterations":iterations, "replace_frame":replace_frame})
